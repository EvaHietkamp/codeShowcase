...
$subject = "$from" . " " . "$productName7" . " RESIN BLUE 01-";
...
<div class="imgItemPage col-8">
  <div class="previewItemPage col-1">
    <img src="<?php echo $productImg71 ?>" onclick="myFunction(this)">
    <img src="<?php echo $productImg72 ?>" onclick="myFunction(this)">
    <img src="<?php echo $productImg74 ?>" onclick="myFunction(this)">
  </div>
  <div class="fullImgItemPage col-11">
    <img id="imageBox" src="<?php echo $productImg71 ?>" alt="">
  </div>
    ...
    <img src="<?php echo $productImg74 ?>" onclick="myFunction(this)">
      ...
      <div class="infoItemPage col-4">
        <div class="textInfoItemPage col-12">
          <h1><?php echo $productName7 ?></h1>
          <p><?php echo $productAuthor7 ?></p>
          <p>Size: <?php echo $productSize7 ?></p>
          <p>Ships in a box</p>
        </div>
        <div class="priceItemPage col-12">
          <h2 class="priceItemPages col-4"><?php echo $productPrice7 ?></h2>

          <!-- adding button, contact us and art description-->
          <?php require '../buttoncontact.php';?>

        <div class="textDescriptionItemPage col-12">
          <p><?php echo $productDetails7 ?></p>
