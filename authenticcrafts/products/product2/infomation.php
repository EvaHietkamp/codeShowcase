...
$ip = $_SERVER['REMOTE_ADDR'];
  ...
  $subject = "$from" . " " . "$productName2" . "RESIN BLUE 02-";
...
?>
      <div class="formCheckout col-9">
        <form action="../thankyou.php" name="form" onsubmit="return validate(this);" method="post">
          <input type="hidden" name="product" value="<?php echo $productName2 ?> - price= <?php echo $productPrice99 ?>">

          <div class="order">
            <p class="headerText"><?php echo $headerInfo ?></p>
            <div class="ship"><p>Art Piece:</p></div>
            <div class="shipOrder"><p><b><?php echo $productName2 ?></b></p></div>
