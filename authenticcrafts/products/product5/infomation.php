...
$subject = "$from" . " " . "$productName5" . "RESIN BLUE 02-";
...
?>
      ...
      <div class="formCheckout col-9">
        <form action="../thankyou.php" name="form" onsubmit="return validate(this);" method="post">
          <input type="hidden" name="product" value="<?php echo $productName5 ?> - price= <?php echo $productPrice79 ?>">

          <div class="order">
            <p class="headerText"><?php echo $headerInfo ?></p>
            <div class="ship"><p>Art Piece:</p></div>
            <div class="shipOrder"><p><b><?php echo $productName5 ?></b></p></div>
