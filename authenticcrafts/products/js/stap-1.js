function validate() {
  ...
  if( document.form.straat.value == "" ){
    document.getElementById("required4").innerHTML = "<p style=padding:5px;>Please enter your straat name</p>";
    return false;
  }
  if( document.form.huisnummer.value == "" ){
    document.getElementById("required5").innerHTML = "<p style=padding:5px;>Please enter your house nr.</p>";
    return false;
  }
  if( document.form.postcode.value == "" ){
    document.getElementById("required6").innerHTML = "<p style=padding:5px;>Please enter your postal code</p>";
    return false;
  }
  if( document.form.plaats.value == "" ){
    document.getElementById("required7").innerHTML = "<p style=padding:5px;>Please enter your city</p>";
    return false;
  }
